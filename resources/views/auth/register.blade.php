                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="sexo" type="text" class="form-control @error('sexo') is-invalid @enderror" name="sexo" value="{{ old('sexo') }}">
                        ...
                        <div class="row mb-3">
                            <label for="carnet" class="col-md-4 col-form-label text-md-end">{{ __('Carnet') }}</label>

                            <div class="col-md-6">
                                <input id="carnet" type="text" class="form-control @error('carnet') is-invalid @enderror" name="carnet" value="{{ old('carnet') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tipo_sangre" type="text" class="form-control @error('tipo_sangre') is-invalid @enderror" name="tipo_sangre" value="{{ old('tipo_sangre') }}">
                        ...
                        <div class="row mb-3">
                            <label for="contacto_emerg" class="col-md-4 col-form-label text-md-end">{{ __('Contacto de Emergencia') }}</label>

                            <div class="col-md-6">
                                <input id="contacto_emerg" type="text" class="form-control @error('contacto_emerg') is-invalid @enderror" name="contacto_emerg" value="{{ old('contacto_emerg') }}">

                                @error('contacto_emerg')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_nac" type="date" class="form-control @error('fecha_nac') is-invalid @enderror" name="fecha_nac" value="{{ old('fecha_nac') }}">
